...
$('.reinput').click(function () {
    ...
    $('#m-name').val(per.getElementsByClassName('s-poo-name')[0].innerHTML);
    $('#m-cif').val(per.getElementsByClassName('s-prof-name')[0].innerHTML);
    $('#m-kvot').val(per.getElementsByClassName('s-free-places')[0].innerHTML);
    $('#m-budshet').val(per.getElementsByClassName('s-os-obs')[0].innerHTML);
    $('#m-nbudzhet').val(per.getElementsByClassName('s-pricaz')[0].innerHTML);
